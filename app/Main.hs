...
import qualified Data.ByteString.Lazy.Char8 as Data.ByteString.Char8
...
renderDiff JSON _ derivation = Data.ByteString.Char8.putStrLn (Data.Aeson.encode derivation)
